        ...
        {#each tracks as track, index}
            ...
            >
                ...
                <td>
                    ...
                    <p class="ellipsis">
                        {#if track.explicit}
                            <span class="tag is-danger mr-1" title="Explicit lyrics">E</span>
                        {/if}
                ...
                <td class="px-0">
                    {#if track.liked}
                        <button class="button" on:click={() => likeTrack(track)} title="Remove track like">
                    ...
                    {:else}
                        <button class="button" on:click={() => likeTrack(track)} title="Like track">
                            <svg class="icon" viewBox="0 0 24 24">
                                <path
                ...
                <td class="pl-0" class:is-hidden-mobile={!isMusicQueue}>
                    {#if isMusicQueue}
                        <button
                            ...
                            title="Remove track from play queue"
                        >
                            <svg class="icon" viewBox="0 0 24 24">
                                <path
                    ...
                    {:else}
                        <button
                            class="button"
                            on:click={() => $musicPlayer.addTrack(track)}
                            title="Add track to play queue"
                        >
                            <svg class="icon" viewBox="0 0 24 24">
                                <path
