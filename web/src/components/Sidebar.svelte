...
<div class="sidebar box has-background-white-bis m-0">
        ...
        {#if authUser == null}
            <ul class="menu-list mb-5">
                ...
                <li>
                    <a
                        href="/auth/login"
                        class:is-active={$page.url.pathname == "/auth/login"}
                    >
                        <svg class="icon is-inline mr-2" viewBox="0 0 24 24">
                            <path
        ...
        {:else}
            ...
            <ul class="menu-list mb-5">
                ...
                <li>
                    <a
                        href="/tracks"
                        class:is-active={$page.url.pathname == "/tracks"}
                    >
                        <svg class="icon is-inline mr-2" viewBox="0 0 24 24">
                            <path
            ...
            <ul class="menu-list mb-5">
                <li>
                    <a
                        href="/admin/users"
                        class:is-active={$page.url.pathname == "/admin/users"}
                    >
                        <svg class="icon is-inline mr-2" viewBox="0 0 24 24">
                            <path
    ...
    {#if authUser != null}
        ...
        <div class="buttons">
            <button class="button is-link is-fullwidth" on:click={logout}
                >Logout</button
            >
        </div>
    {/if}
    ...
    <p>
        Made with
        <svg
            class="icon is-inline is-colored"
            viewBox="0 0 24 24"
        ...
        by<br />
        <a href="https://bplaat.nl" target="_blank" rel="noreferrer"
            >Bastiaan van der Plaat</a
        >
    </p>
</div>
