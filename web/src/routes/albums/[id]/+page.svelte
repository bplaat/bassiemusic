...
<div class="columns">
    <div class="column is-one-quarter mr-5 mr-0-mobile">
        <div class="box has-image p-0 has-image-tags" style="aspect-ratio: 1;">
            <img src={album.large_cover} alt="Cover of album {album.title}" loading="lazy" />
    ...
    <div class="column" style="display: flex; flex-direction: column; justify-content: center;">
        ...
        <div class="buttons">
            <button class="button is-large" on:click={tracksTable.playFirstTrack} title="Play album">
                <svg class="icon" viewBox="0 0 24 24">
            ...
            {#if album.liked}
                <button class="button is-large" on:click={likeAlbum} title="Remove album like">
            ...
            {:else}
                <button class="button is-large" on:click={likeAlbum} title="Like album">
                    <svg class="icon" viewBox="0 0 24 24">
                        <path
