...
if [ "$1" = "release" ]; then
    ...
    ld -s --subsystem windows build/bassiemusic.o build/resource.o -e _start \
        -L"C:\\Windows\\System32" -lkernel32 -luser32 -lgdi32 -lshell32 -lole32 -lversion -o build/bassiemusic-win64/bassiemusic.exe
...
ld build/bassiemusic.o build/resource.o -e _start \
    -L"C:\\Windows\\System32" -lkernel32 -luser32 -lgdi32 -lshell32 -lole32 -lversion -o build/bassiemusic.exe
